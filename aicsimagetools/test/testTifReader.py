...
class SetUpTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.reader0 = tifReader.TifReader(os.path.join(self.dir_path, 'img', 'img40_1_dna.tif'))
        self.reader1 = tifReader.TifReader(os.path.join(self.dir_path, 'img', 'img40_1_memb.tif'))
        self.reader2 = tifReader.TifReader(os.path.join(self.dir_path, 'img', 'img40_1_struct.tif'))
        self.reader3 = tifReader.TifReader(os.path.join(self.dir_path, 'img', 'img40_1_seg_cell.tif'))
        self.reader4 = tifReader.TifReader(os.path.join(self.dir_path, 'img', 'img40_1_seg_nuc.tif'))
