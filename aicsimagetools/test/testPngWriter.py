...
class SetUpTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.writer = pngWriter.PngWriter(os.path.join(self.dir_path, 'img', 'pngwriter_test_output.png'))
        self.reader = cziReader.CziReader(os.path.join(self.dir_path, 'img', 'T=5_Z=3_CH=2_CZT_All_CH_per_Slice.czi'))
        self.comparisonreader = pngReader.PngReader(os.path.join(self.dir_path, 'img', 'czi_output_comparison.png'))
...
class PngSaveComparisonTestCase(SetUpTestCase):
    ...
    def runTest(self):
        ...
        output_image = pngReader.PngReader(os.path.join(self.dir_path, 'img', 'pngwriter_test_output.png')).load()
